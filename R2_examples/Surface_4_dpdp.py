...
Example of a pyres implementation of "Surface electorde array 4" from the 
R2_v3.1_readme.pdf
...
ex_dir = r'C:\ER' 
work_dir = os.path.join(ex_dir,r'R2_examples\Surface_4\dpdp\Forward')
inv_work_dir = os.path.join(ex_dir,r'R2_examples\Surface_4\dpdp\Inverse')
...
r2_dict = {'survey_name':'Surface_4_dpdp',
...
# For Surface_4, only add new value for 'alpha_aniso' from default of 1.0
inv_options.update({'alpha_aniso':0.1})
