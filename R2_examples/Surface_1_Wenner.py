...
Example of a pyres implementation of "Surface electorde array 1" from the 
R2_v3.1_readme.pdf
...
ex_dir = r'C:\ER' 
work_dir = os.path.join(ex_dir,r'R2_examples\Surface_1\Wenner\Forward')
inv_work_dir = os.path.join(ex_dir,r'R2_examples\Surface_1\Wenner\Inverse')
...
r2_dict = {'survey_name':'Surface_1_Wenner',
...
synth_dict = {'n_electrodes':n_electrodes,'array_type':'Wenner',
              'max_separation':8}
